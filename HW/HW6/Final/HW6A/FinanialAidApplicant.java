...
public class FinanialAidApplicant
{
    ...
    public boolean qualifies()
    {
        ...
        else if(houseIncome <= 60000 && numOfPeopleInHouse >= 4)
        {
            status = true;
        }
        else if(houseIncome > 60000 && houseIncome <= 150000 && numOfPeopleInHouse >= 6)
        {
            status = true;
        }
        else if(houseIncome > 150000)
        {
            status = false;
        }
        return status;
