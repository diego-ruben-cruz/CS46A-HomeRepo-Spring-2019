...
public class IntArrayTester
{
    public static void main(String[] args)
    {
        ...
        System.out.println(util.displaySum());
        System.out.println("Expected: 5+3+7+1+4+7+6=33");
        System.out.println(util2.displaySum());
        System.out.println("Expected: -7+-2+-9+-4+-7+-6+-1+-5+-7=-48");
        System.out.println(util3.displaySum());
        System.out.println("Expected: =0");
